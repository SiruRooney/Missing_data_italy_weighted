...
Gibbs.sampler<-function(predata,rs.ind,ind,iter.Gibs,wgh){
  source("F://Missingdatacodes//Missing_data_italy_weighted//MisGibsfunction3.9.2.R")
...
library("MASS")
result1=Gibbs.sampler(Italy.dummy,rs.indicator,indicator.italy,90,Weigh)
save.image("F://Missingdatacodes//Missing_data_italy_weighted//step3(1)_GibMisinRstudio9.2.RData")
proc.time()-ptm
